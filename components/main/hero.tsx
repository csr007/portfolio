    ...
    <video
      ...
      style={{
        ...
        ...(isMobile
          ...
          : { transform: "scale(0.92)" }) // ✅ Desktop: slight reduction to avoid cutoff on big screens
      }}
    >
      <source
...
export const Hero = () => {
  return (
    <div className="relative flex flex-col h-full w-full">
      <Suspense
        fallback={
          <div className="absolute top-[-420px] left-0 w-full h-full bg-black -z-20" />
        }
      >
        <VideoBackground />
      </Suspense>
